...
DRCTib<-WorldTibble%>%
  mutate(Country = ifelse(Country %in% c("Congo (Kinshasha)", "Congo, Dem. Republic", "Congo, Democratic Republic of the", "Democratic Republic of the Congo", "DR Congo", "Congo, Dem. Rep."), "Congo (Kinshasha)", Country),
         Country = ifelse(Country =="Congo (Kinshasha)", )%>%
  filter(Country == "Congo (Kinshasha)")%>%
